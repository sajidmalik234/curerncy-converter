...
<div className=" w-full max-w-lg mx-auto h-100 flex flex-col justify-center items-center text-white p-8 bg-gradient-to-r rounded-xl from-black/30 to-black/25">
  <img 
  ...
  >
    ...
    Connect with me on LinkedIn
      ...
      <div className="w-full max-w-2xl mx-auto border border-gray-60 rounded-xl p-8 backdrop-blur-sm bg-white/30 shadow-lg">
